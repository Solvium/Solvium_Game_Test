...
function Home() {
  ...
  const getAllUserTasks = async (data: any) => {
    try {
      ...
      const res = await axios.get(`/api/allroute?type=allusertasks&id=${data.id}`);
      if (res.status === 200) {
      ...
      <div className="max-w-[430px] mx-auto relative min-h-screen">
        <div className="flex flex-col h-screen">
          <div className="flex-1 overflow-y-auto pb-20">
            ...
            {selectedTab === "Leaderboard" && <LeaderBoard leader={leader} />}
          </div>
              ...
              <div className="flex justify-between items-center px-4 py-2">
                ...
                >
                  <svg className="w-6 h-6 mb-1" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <path d="M3 9L12 3L21 9V15L12 21L3 15V9Z" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                  </svg>
